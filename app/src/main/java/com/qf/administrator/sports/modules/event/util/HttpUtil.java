...
import com.qf.administrator.sports.util.ThreadTask;
...
public class HttpUtil {
    ...
    public static void doHttpReqeustNews(final String method, final String url,
                                     final HashMap<String, String> params, final BaseCallBack callBack) {
        HttpMethod m = HttpMethod.GET;
        final RequestParams requestParams = new RequestParams(url);
            requestParams.addHeader("apikey","f0548c958a87eb740e1abb7c8de9e440");
        if ("POST".equals(method)) {
            m = HttpMethod.POST;
            Set<Map.Entry<String, String>> sets = params.entrySet();
            // 将Hashmap转换为string
